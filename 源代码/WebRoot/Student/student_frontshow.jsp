...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Student/frontlist">报名学生信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户名:</div>
		<div class="col-md-10 col-xs-6"><%=student.getUser_name()%></div>
	</div>
	 
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">报名比赛:</div>
		<div class="col-md-10 col-xs-6"><%=student.getContest().getContestName() %></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=student.getSignUpTime()%></div>
	</div>
	<div class="row bottom15">
