...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">知识竞赛网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Score/frontlist">成绩排名分布</a></li>
                <!-- <li><a href="<%=basePath %>TikuType/frontlist">题库类别</a></li> -->
                <li><a href="<%=basePath %>Tiku/frontlist">在线做题</a></li>
                <li><a href="<%=basePath %>Notice/frontlist">公告指南</a></li>
                <li><a href="<%=basePath %>WebLink/frontlist">友情链接</a></li>
