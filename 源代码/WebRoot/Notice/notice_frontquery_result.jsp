...
<%
    ...
    String noticeType = (String)request.getAttribute("noticeType"); //新闻类别查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>公告id</td><td>标题</td><td>新闻类别</td><td>发布时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="noticeQueryForm" id="noticeQueryForm" action="<%=basePath %>Notice/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="noticeType">新闻类别:</label>
				<input type="text" id="noticeType" name="noticeType" value="<%=noticeType %>" class="form-control" placeholder="请输入新闻类别">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="notice_noticeType_edit" class="col-md-3 text-right">新闻类别:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="notice_noticeType_edit" name="notice.noticeType" class="form-control" placeholder="请输入新闻类别">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (notice, response, status) {
			if (notice) {
				...
				$("#notice_noticeType_edit").val(notice.noticeType);
