...
public class Student {
    ...
    public JSONObject getJsonObject() throws JSONException {
		...
		jsonStudent.accumulate("contest", this.getContest().getContestName());
		jsonStudent.accumulate("contestPri", this.getContest().getContestId());
		...
		jsonStudent.accumulate("signUpTime", this.getSignUpTime().length()>19?this.getSignUpTime().substring(0,19):this.getSignUpTime());
		return jsonStudent;
    }}