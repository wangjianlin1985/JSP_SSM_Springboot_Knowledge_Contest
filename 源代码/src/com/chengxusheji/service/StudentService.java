...
public class StudentService {
    ...
    /*按照查询条件分页查询报名学生记录*/
    public ArrayList<Student> queryStudent(String user_name,Contest contest,String name,String birthDate,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_student.user_name like '%" + user_name + "%'";
    	if(null != contest && contest.getContestId()!= null && contest.getContestId()!= 0)  where += " and t_student.contest=" + contest.getContestId();
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String user_name,Contest contest,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_student.user_name like '%" + user_name + "%'";
    	if(null != contest && contest.getContestId()!= null && contest.getContestId()!= 0)  where += " and t_student.contest=" + contest.getContestId();
    	if(!name.equals("")) where = where + " and t_student.name like '%" + name + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String user_name,Contest contest,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!user_name.equals("")) where = where + " and t_student.user_name like '%" + user_name + "%'";
    	if(null != contest && contest.getContestId()!= null && contest.getContestId()!= 0)  where += " and t_student.contest=" + contest.getContestId();
    	if(!name.equals("")) where = where + " and t_student.name like '%" + name + "%'";
